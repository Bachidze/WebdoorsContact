...
export default function Footer() {
  ...
  return (
    <footer className="mt-[60px] w-[92%]  m-auto max-w-[1920px] md:mt-[160px] 3xl:w-[75%]">
      <section className="hidden 3xl:flex flex-col items-center mt-[574px] mb-[160px]">
        <div className="flex flex-wrap  w-[100%] justify-between">
          <img
            ...
            src="/assets/PirveliSponsoriWebdoors.svg"
            alt="firstSponsor"
          />
          <img
            className="w-[204px] h-[62px]"
            src="/assets/Sharm.svg"
            alt="Sharm"
          />
          <img
            className="w-[273px] h-[62px]"
            src="/assets/SqartveloWebdoors.svg"
            alt="Saqartvelo"
          />
          <img
            className="w-[204px] h-[62px]"
            src="/assets/TbilisiWebdoors.svg"
            alt="Tbilisi"
          />
          <img
        ...
        <div className="flex flex-wrap w-[80%] justify-between  mt-[60px]">
          ...
          <img
            ...
            src="/assets/Pitstop.svg"
            alt="Po]itstop"
          />
          <img
            className="w-[87.1px] h-[62px]"
            src="/assets/QartuliSaqme.svg"
            alt="QartuliSaqme"
          />
          <img
            className="w-[244.46px] h-[62px]"
            src="/assets/Proteller.svg"
            alt="Proteller"
          />
          <img
            className="w-[147.62px] h-[62px]"
            src="/assets/Supta.svg"
            alt="Supta"
          />
        </div>
      </section>
